...
const Navbar = () => {
		...
		return (
			<>
				<div className="flex flex-col gap-2 sm:flex-row">
					<Link
						to={'/cinema'}
						className={`flex justify-center gap-2 rounded-md py-1 px-2 text-white hover:bg-gray-500 ${
				...
				<div className="flex grow items-center justify-center gap-3 sm:justify-end">
					{auth.username && (
	...
	return (
		<nav className="flex flex-col items-center justify-between gap-2 bg-gray-900 py-3 px-5 drop-shadow-lg sm:flex-row sm:justify-start">
			...
			<div className="hidden grow justify-between gap-2 sm:flex">{menuLists()}</div>
			{menuOpen && <div className="flex w-full grow flex-col gap-2 sm:hidden">{menuLists()}</div>}
		</nav>
	)
}
